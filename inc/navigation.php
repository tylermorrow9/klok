<div class="navbar">
	...
	<div class="dropdown">
		<a href="<?php echo 'account.php?tok='.$_SESSION["sessionid"]; ?>" class="dropbtn">Account <i class="fa fa-caret-down"></i></a>
	...
	<div class="dropdown">
		<a href="<?php echo 'administration.php?tok='.$_SESSION["sessionid"]; ?>" class="dropbtn">Administration <i class="fa fa-caret-down"></i></a>
		<div class="dropdown-content">
